...
names(safe) <- c("년월","경찰서","설문대상인원_전체","설문대상인원_남","설문대상인원_여","설문대상인원_20대이하","설문대상인원_30대","설문대상인원_40","설문대상인원_50대","설문대상인원_60대","종합체감안전도_점수","전반적안전도_점수","분야별안전도_점수","범죄안전도_점수","교통사고안전도_점수","법질서준수도_점수","절도폭력안전도_점수","강도살인안전도_점수","전반적경찰노력도_점수")

#년도별 정리
safe$년월 <- substr(safe$년월,1,4) 
